...
- `docs/game_design/mechanics.md` – main game design document, metaphors, systems, and mechanics.
- `docs/game_design/glossary.md` – glossary of architectural, programming, and in‑world terms.
