...
**Flow documentation**: Backend/frontend flow (with TODO branches) is tracked in [`docs/logic-mindmap.md`](docs/logic-mindmap.md). **Whenever you modify flow-relevant logic, update that file** to keep agent guidance accurate.
