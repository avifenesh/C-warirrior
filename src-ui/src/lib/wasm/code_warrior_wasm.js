...
export class WasmGame {
    ...
    load_level(level_id) {
        ...
        const ret = wasm.wasmgame_load_level(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
     ...
     * @param {number} xp_reward
     * @returns {any}
     */
    complete_level(xp_reward) {
        const ret = wasm.wasmgame_complete_level(this.__wbg_ptr, xp_reward);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    get_game_state() {
        const ret = wasm.wasmgame_get_game_state(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    get_level_data() {
        const ret = wasm.wasmgame_get_level_data(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    process_action(action_json) {
        const ret = wasm.wasmgame_process_action(this.__wbg_ptr, action_json);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    init_from_state(state_json) {
        const ret = wasm.wasmgame_init_from_state(this.__wbg_ptr, state_json);
        if (ret[1]) {
     ...
     */
    get_render_state() {
        const ret = wasm.wasmgame_get_render_state(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {number} total_xp
     * @param {string[]} completed_levels
     */
    sync_progression(total_xp, completed_levels) {
        const ptr0 = passArrayJsValueToWasm0(completed_levels, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.wasmgame_sync_progression(this.__wbg_ptr, total_xp, ptr0, len0);
    }
    /**
    ...
    get_available_levels() {
        const ret = wasm.wasmgame_get_available_levels(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    get_hint(hint_index) {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wasmgame_get_hint(this.__wbg_ptr, hint_index);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('code_warrior_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
